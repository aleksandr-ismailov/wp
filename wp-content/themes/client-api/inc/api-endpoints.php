<?php
/**
 * REST API endpoints for client-api theme
 *
...
function client_api_single_page_endpoint( $request ) {
	...
	$page_data = array(
		...
		'form_settings'  => array(
			'form_title'       => get_post_meta( $page->ID, 'form_title', true ),
			'form_description' => get_post_meta( $page->ID, 'form_description', true ),
			'button_text'      => get_post_meta( $page->ID, 'button_text', true ),
			'button_variant'   => get_post_meta( $page->ID, 'button_variant', true ),
			'button_size'      => get_post_meta( $page->ID, 'button_size', true ),
			'card_variant'     => get_post_meta( $page->ID, 'card_variant', true ),
			'form_width'       => get_post_meta( $page->ID, 'form_width', true ),
		),
	);
